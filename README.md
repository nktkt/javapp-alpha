...
- `data class` copy helpers: `copy(...)` and per-field `withName(...)` methods
- method-bearing `data class` lowered to final classes with constructors, accessors, copy helpers, and value methods
